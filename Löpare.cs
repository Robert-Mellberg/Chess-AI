...
public class Löpare : Pjäs
{
    public Löpare(string färg) : base(färg, 30)
    {

    }
    public Löpare(string färg, Vector2 location) : base(färg, location, "löpare", 300)
    {

    }

    int[] förflyttning = { 1,1,-1,-1,1};
